...
- The test matrix also inherited a nonexistent Codecov digest. Tool commit
  `370c971` pins the official `v5.0.0` commit. Hosted tool CI run
  `32020923232` passed lint, type checking, four Python/OS test jobs, security
  scanning, and package build; hosted skills CI run `32020018080` passed.
