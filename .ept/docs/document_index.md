...
**Major Change:** Added DEVOPS-017-deployment-report.md and DEVOPS-018-deployment-report.md — packaging and deployment verification reports for DEV-STORY-017 (foundry-connectivity CLI, 20 ops, 7/13 metadata-only policy, candidate `063f72d`) and DEV-STORY-018 (foundry-media-sets CLI, 19 ops, 5/14 metadata-only policy, candidate `063f72d`), covering clean-archive build, wheel/editable install, entry-point smoke, Python 3.11/3.12 gates, security gates, and rehearsed rollback (2026-08-10).
