...
**Major Change:** DEVOPS-002 — updated CI/package index evidence for the Python 3.11/3.12 matrix, README long description, SDK dependency, Ruff test-only ignores, and repository coverage gate.
