...
**Forbidden:**
- ❌ Access tracking system files directly (.index.csv, .link-index.csv, ticket markdown files)
- ❌ Update tracking system files directly — ALL reads and writes go through `ticket-helper`
