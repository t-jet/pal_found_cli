...
Run `foundry-widgets --help` for syntax. The CLI exposes exactly 8 Widgets v2 operations: `dev-mode-settings enable|set-widget-set-by-id`; `release delete|get|list`; `repository get|publish`; `widget-set get`.
