...
Use `foundry_audit_cli.py` for two Audit API v2 operations:
...
```bash
python foundry_audit_cli.py log-file list <organization_rid> --start-date 2026-08-01
python foundry_audit_cli.py log-file content <organization_rid> <log_file_id>
```
