...
31 Foundry Filesystem API v2 operations are available through `foundry_filesystem_cli.py`.
...
```bash
python foundry_filesystem_cli.py <resource> <operation> [options]
```
