---
name: foundry-third-party-applications
...
Run `foundry-third-party-applications --help` for syntax. The CLI exposes exactly 9 Third-Party Applications v2 operations: `third-party-application get`; `website deploy|get|undeploy`; `version delete|get|list|upload|upload-snapshot`.
